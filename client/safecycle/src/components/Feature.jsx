            ...
            <div className="container mx-auto px-6 pt-16 flex-1 text-center">
                ...
                <div className="container mx-auto px-6 py-16 flex flex-col md:flex-row gap-100">
                    <div className="flex-1 flex flex-col items-center text-center">
                        <img src={image1} alt="Stay Informed" className="w-full h-auto rounded-lg shadow-lg mb-4"/>
                    ...
                    <div className="flex-1 flex flex-col items-center text-center">
                        <img src={image2} alt="Stay Safe" className="w-full h-auto rounded-lg shadow-lg mb-4"/>
